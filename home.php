...
<div class="thumbnail">
    ...
    <div class="caption-full">
        ...
        <p align="justify">
        SQL injection considerably one of the most critical issues in application Zeta Ed security is an attack technique by which a malicious user can run SQL code with the privilege on which the application is configured. Error based SQL injections are easy to detect and exploit further. It responds to user’s request with detailed backend error messages. These error messages are generated because of specially designed user requests such that it breaks the SQL query syntax used in the application. 
        </p>
